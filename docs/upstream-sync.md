...
| 2026-08-12 | `v5` | `5a306c9bd0caa1b65f5c73607eb0de7e60111078` | action-battle/client/server/testing/tiledmap/vite/vue `5.0.0-beta.30`; common `5.0.0-beta.28`; Studio `5.0.0-beta.32`; chat `5.0.0-beta.3` | Audited in `docs/internal/upstream-beta30-audit.md`; tracking fast-forward, exact-SHA fork CI, product port, independent review, and coordinated Solo release remain required |
